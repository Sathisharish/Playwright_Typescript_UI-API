...
Locator: locator('h6')
Expected substring: "You are currently in Main Dispensary dispensary. To change, you can always click here."
Timeout: 5000ms
...
- generic [ref=e4]:
  ...
  - generic [ref=e27]:
    ...
    - generic [ref=e135]:
      - generic [ref=e136]:
        - generic [ref=e137]:
          - generic [ref=e138]: "Active Dispensary : Main Dispensary"
          - generic [ref=e139] [cursor=pointer]: 
        - list [ref=e140]:
          - listitem [ref=e141] [cursor=pointer]:
            - link "Prescription" [ref=e142]:
          ...
          - listitem [ref=e147] [cursor=pointer]:
            - link "Counter " [ref=e148]:
              - /url: "#/Dispensary/ActivateCounter"
              - text: Counter
              - generic [ref=e149]: 
          - listitem [ref=e150] [cursor=pointer]:
            - link "Reports" [ref=e151]:
              - /url: "#/Dispensary/Reports"
              - text: Reports
          - listitem [ref=e152] [cursor=pointer]:
            - link "Patient Consumption" [ref=e153]:
              - /url: "#/Dispensary/PatientConsumptionMain"
              - text: Patient Consumption
      - generic [ref=e155]:
        - heading "Counter Selection" [level=3] [ref=e159]:
          - generic [ref=e160]: Counter Selection
        - generic [ref=e164]:
          - heading "Morning Counter click to Activate" [level=5] [ref=e168] [cursor=pointer]:
            - text: Morning Counter
            - generic [ref=e169]: click to Activate
          - heading "Evening Counter click to Activate" [level=5] [ref=e173] [cursor=pointer]:
            - text: Evening Counter
            - generic [ref=e174]: click to Activate
          - heading "Night Counter click to Activate" [level=5] [ref=e178] [cursor=pointer]:
            - text: Night Counter
            - generic [ref=e179]: click to Activate
```
...
> 25 |   await expect(this.page.locator('h6')).toContainText('You are currently in Main Dispensary dispensary. To change, you can always click here.');
     |                                         ^ Error: expect(locator).toContainText(expected) failed
  26 |   await this.page.locator('div').filter({ hasText: /^Night Counter click to Activate$/ }).nth(2).click();
  27 |   
  28 |   }
  29 | }
```