...
Call log:
  - waiting for locator('a').filter({ hasText: 'Main Dispensarydispensary' }) to be visible
      ...
      - generic [ref=e137]:
        - generic [ref=e142] [cursor=pointer]:
          - generic [ref=e143]:
            - generic [ref=e144]:
              ...
              - generic [ref=e146]: "Total Patient: 1038"
            - generic [ref=e147]: "1038"
          - generic [ref=e148]:
            - generic [ref=e149]: "Today : 0"
        ...
        - generic [ref=e169]:
          - generic [ref=e171]:
            ...
            - generic [ref=e174]: "Follow up :"
            - generic [ref=e175]: "Referrals :"
          - generic [ref=e176]:
            - generic [ref=e177]: "Cancelled :"
            - generic [ref=e178]: "Returned : 0"
      - generic [ref=e181]:
        - generic [ref=e182]:
          - generic [ref=e183]:
            - generic [ref=e184]: 
            - generic [ref=e185]: Department wise appointment count on 02-05-2026
          - generic [ref=e186]:
        ...
        - generic [ref=e193]:
          - img [ref=e194]
          - link "JavaScript charts":
            - /url: http://www.amcharts.com/javascript-charts/
```
...
> 23 |    await this.MainDispensary.waitFor();
     |                              ^ Error: locator.waitFor: Test timeout of 30000ms exceeded.
  24 |   await this.page.locator('a').filter({ hasText: 'Main Dispensarydispensary' }).click();
  25 |   await this.MainDispensaryToolTip.waitFor();
  26 |   await expect(this.page.locator('h6')).toContainText('You are currently in Main Dispensary dispensary. To change, you can always click here.');
  27 |   await this.page.locator('div').filter({ hasText: /^Night Counter click to Activate$/ }).nth(2).click();
  28 |   
  29 |   }
  30 | }
```